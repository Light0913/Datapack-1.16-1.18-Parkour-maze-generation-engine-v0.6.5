...
- II. Enclose a closed area with bedrock or barrier or ordinary stone bricks (bedlock/barrier/stone_bricks)
...
- III. Fill in the inner area of the enclosed space with the box you like
...
- IV. Put yourself in this closed space, and then! Use the command to start building the maze!
...
- V. Wait patiently for the completion of maze construction. You can use the following instructions to check the remaining steps of maze construction:
...
- VI. If you want to stop ahead of time (can't wait or feel that the maze will not continue to build)
...
- II. Use the functions of the example series
...
- III. Multiple steps in one frame:
